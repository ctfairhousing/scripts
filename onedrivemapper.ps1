...
#     @{"displayName"="Shared";"targetLocationType"="networklocation";"targetLocationPath"="$env:APPDATA\Microsoft\Windows\Network Shortcuts";"sourceLocationPath"="https://ctfairhousing.sharepoint.com";"mapOnlyForSpecificGroup"=""}
...
$loginformIntroText    = "Welcome to ctfairhousing`r`nPlease enter your login and password" #used as introduction text when you set userLookupMode to 6
...
function MapDrive{ 
    ...
    if($driveMapping.targetLocationType -eq "driveletter"){
        $LASTEXITCODE = 0
        $driveMapping.webDavPath = "\\ctfairhousing.sharepoint.com@SSL\DavWWWRoot"
